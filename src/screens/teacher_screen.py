...
def teacher_dashboard():
    ...
    with c2:
        ...
        if st.button("Logout", type ="secondary",key = "teacher_loginbackbtn",shortcut ="control+backspace"):
...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username =st.text_input("Enter username",placeholder="Subhashree")
...
def  register_teacher(teacher_name,teacher_username,teacher_pass,teacher_pass_confirm):
    if not all ([teacher_username, teacher_name,teacher_pass,teacher_pass_confirm]):
...
def teacher_screen_register():
    ...
    teacher_username =st.text_input("Enter username",placeholder="subhashree")
    teacher_name =st.text_input("Enter name",placeholder="Subhashree")
    teacher_pass =st.text_input("Enter password",type="password",placeholder ="Enter password")
